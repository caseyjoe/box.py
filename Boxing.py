...
def classifyPose(landmarks, output_image, display=False):
    ...
    # Check if it is the guard pose or hands down pose.
    # As for both of them, both shoulders should be less than the specific angle.
    #----------------------------------------------------------------------------------------------------------------

        # Check if both shoulders are less than the required angle.
        if left_shoulder_angle < 45 and right_shoulder_angle < 45:

    # Check if it is the guard pose.
    #----------------------------------------------------------------------------------------------------------------

            # Check if both elbow angles are less than the required angle.
            if left_elbow_angle < 45 and right_elbow_angle < 45:

                    # Specify the label of the pose that is Guard pose.
                    label = 'Guard'
                        
    #----------------------------------------------------------------------------------------------------------------
    
    # Check if it is the hands down pose.
    #----------------------------------------------------------------------------------------------------------------
    ...
    # Check if it is the left straight punch.
    #----------------------------------------------------------------------------------------------------------------
    
    # Check if left arm is extended and not by the user's side
    if left_elbow_angle > 135 and left_shoulder_angle > 90:
    ...
    # Check if it is the Right straight punch.
    # ----------------------------------------------------------------------------------------------------------------

    # Check if left arm is extended and not by the user's side
    if right_elbow_angle > 135 and right_shoulder_angle > 90:
        # Specify the label of the pose that is tree pose.
        label = 'Right straight'
